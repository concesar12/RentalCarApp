...
<h1 class="fa fa-align-center" aria-hidden="true">Edit/Update Users</h1>
      ...
      if(mysqli_num_rows($user_result) > 0) {
        while ($row = mysqli_fetch_assoc($user_result)) {
          echo "<tr><td>". $row["id"] ."</td><td>". $row["Email"]
           ."</td><td>". $row["Username"] ."</td><td>". $row["Role"] ."</td><td>". "<div class='btn-group'>
           <a class='btn btn-secondary' href='ed_user.php?id=" .$row['id'] ."'>Edit</a>
